...
class DiffusionPipeline(ConfigMixin, PushToHubMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        # import pdb
        # pdb.set_trace()
        # new_text_model = CLIPTextModel.from_pretrained(kwargs['text_model_id'])

        # new_text_model = PeftModel.from_pretrained(new_text_model, kwargs['text_lora_id'])



        new_text_model = PeftModel.from_pretrained(init_kwargs['text_encoder'], kwargs['text_lora_id'], adapter_name='text')
        init_kwargs['text_encoder'] = new_text_model
