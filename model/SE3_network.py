...
from utils.equivariant_attention.modules import get_basis_and_r, GSE3Res, GNormBias
from utils.equivariant_attention.modules import GConvSE3, GNormSE3
from utils.equivariant_attention.fibers import Fiber

class TFN(nn.Module):
    """SE(3) equivariant GCN"""
    def __init__(self, num_layers=1, num_channels=8, num_nonlin_layers=1, num_degrees=2, 
                 l0_in_features=8, l0_out_features=8,
                 l1_in_features=3, l1_out_features=3,
                 num_edge_features=8, use_self=True):
        super().__init__()
        # Build the network
