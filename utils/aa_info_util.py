...
def init_reverse_res_name_map():
    reverse_name_map = {"ALA": "A",
                        "CYS": "C",
                        "ASP": "D",
                        "GLU": "E",
                        "PHE": "F",
...
def init_aa_edge_index():
    aa_edge_index = {"A": [[0, 1, 1, 1, 2, 2, 3, 4],
           [1, 0, 2, 4, 1, 3, 2, 1]],
     "C": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5],
           [1, 0, 2, 4, 1, 3, 2, 1, 5, 4]],
    "D": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 5, 6, 7],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 7, 5, 5]],
    "E": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 6, 6, 6, 7, 8],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 5, 7, 8, 6, 6]],
    "F": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 5, 6, 6, 7, 7, 8, 8, 9, 9, 10, 10],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 7, 5, 8, 5, 9, 6, 10, 7, 10, 8, 9]],
    "G": [[0, 1, 1, 2, 2, 3],
          [1, 0, 2, 1, 3, 2]],
    "H": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 5, 6, 6, 7, 7, 8, 8, 9, 9],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 7, 5, 8, 5, 9, 6, 9, 7, 8]],
    "I": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 4, 5, 5, 6, 7],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 6, 4, 7, 4, 5]],
    "K": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 6, 6, 7, 7, 8],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 5, 7, 6, 8, 7]],
    "L": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 5, 6, 7],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 7, 5, 5]],
    "M": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 6, 6, 7],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 5, 7, 6]],
    "N": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 5, 6, 7],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 7, 5, 5]],
    "P": [[0, 0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 6, 6],
          [1, 6, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 0, 5]],
    "Q": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 6, 6, 6, 7, 8],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 5, 7, 8, 6, 6]],
    "R": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 6, 6, 7, 7, 8, 8, 8, 9, 10],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 5, 7, 6, 8, 7, 9, 10, 8, 8]],
    "S": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4]],
    "T": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 4, 5, 6],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 6, 4, 4]],
    "V": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 4, 5, 6],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 6, 4, 4]],
    "W": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 5, 6, 6, 7, 7, 7, 8, 8, 9, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 7, 5, 8, 5, 9, 10, 6, 9, 7, 8, 11, 7, 12, 9, 13, 10, 13, 11, 12]],
    "Y": [[0, 1, 1, 1, 2, 2, 3, 4, 4, 5, 5, 5, 6, 6, 7, 7, 8, 8, 9, 9, 10, 10, 10, 11],
          [1, 0, 2, 4, 1, 3, 2, 1, 5, 4, 6, 7, 5, 8, 5, 9, 6, 10, 7, 10, 8, 9, 11, 10]],}

    return aa_edge_index
